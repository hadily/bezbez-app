...
const routes: Routes = [
  ...
  { 
    ...
    loadChildren: () => import('./pages/user/item-details/item-details.module').then(m => m.ItemDetailsPageModule)
  },
  {
    path: 'cart',
  ...
  {
    path: 'likes',
    loadChildren: () => import('./pages/user/likes/likes.module').then( m => m.LikesPageModule)
  },
  {
    path: 'profile',
    loadChildren: () => import('./pages/user/profile/profile.module').then( m => m.ProfilePageModule)
  ...
  
  {
    ...
    loadChildren: () => import('./pages/user/search-articles/search-articles.module').then( m => m.SearchArticlesPageModule)
  },
  {
    path: 'search-bezbezes',
    loadChildren: () => import('./pages/user/search-bezbezes/search-bezbezes.module').then( m => m.SearchBezbezesPageModule)
  },
  {
  ...
  {
    path: 'payment-method',
    loadChildren: () => import('./pages/user/payment-method/payment-method.module').then( m => m.PaymentMethodPageModule)
  },
  {
    path: 'add-card',
    loadChildren: () => import('./pages/user/add-card/add-card.module').then( m => m.AddCardPageModule)
  },
